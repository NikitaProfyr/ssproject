...
from ssproject.settings import STRIPE_SECRET_KEYS, BASE_URL
...
def create_payment_intent_in_item(
    item: Item, payment_method_id: str
...
def create_stripe_session_in_order(order: Order) -> Union[Session]:
    ...
    if coupon_code:
        checkout_params["discounts"] = [{"coupon": coupon_code.pk}]
